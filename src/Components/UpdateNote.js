...
function UpdateNote(props) {
    ...
    const [title, setTitle] = useState(props.location.updateProps.title)
    const [content, setContent] = useState(props.location.updateProps.content)
    ...
    const handleSubmit = (e) => {
        ...
        let request = {
            query: `
            mutation UpdateNote {
                updateNote(noteData: {title: "${title}", content: "${content}", noteId: ${props.location.updateProps.noteId}}) {
                    note {
                        id
                        title
                        content
                        ...
                        <div className="col-span-3 sm:col-span-2">
                            ...
                            <div className="mt-1 flex rounded-md shadow-sm">
                                <input
                                    ...
                                    placeholder={props.location.updateProps.title} />
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="mt-1">
                            <textarea
                                ...
                                placeholder={props.location.updateProps.content}>
                            </textarea>
                        </div>
                    </div>
